...
df_clean = df_clean[df_clean["IMMEDR"].isin([1, 2])]
...
# target: rosu vs galben
def map_red_yellow(x):
    if x == 1:
        return 1   # rosu
    else:
        return 0   # galben

df_clean["target"] = df_clean["IMMEDR"].apply(map_red_yellow)
...
# RFV + categorice pentru CatBoost
...
# probabilități pentru clasa rosu
